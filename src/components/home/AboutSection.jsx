        ...
        <div className="mx-auto">
          <div>
            ...
            <motion.p
              ...
              viewport={{ once: true, amount: 0.3 }}
            >
              Tumbuh Bersama BPR Restu Dewata, Wujudkan Keuangan yang Lebih
          ...
          <div className="gap-12 items-center mx-auto max-w-screen-xl lg:grid lg:grid-cols-2">
            ...
            <div className="lg:w-5/6 mt-10 lg:mt-0 text-center lg:text-left mx-auto">
              ...
              <motion.p
                ...
                viewport={{ once: true, amount: 0.3 }}
              >
                Lembaga perbankan yang telah melayani masyarakat selama lebih
                dari 24 tahun. Dengan pengalaman yang luas dan komitmen untuk

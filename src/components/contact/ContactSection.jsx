          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
            <div className="lg:flex lg:items-center lg:mb-0 mb-10">
              ...
              >
                ...
                <h2 className="text-company-500 font-inter-black text-3xl lg:text-5xl font-semibold lg:mb-36 mb-2 lg:text-left text-center">
            ...
            <div className="lg:max-w-xl w-full flex items-center justify-center ">
              ...
              >
                <div className="lg:w-96 w-auto h-auto bg-white shadow-xl lg:py-10 lg:px-12 p-4 rounded-md">
                  ...
                  <Link
                    to="https://wa.me/6282146485018?text=Halo%20Bank%20Dim%20Nugraha,%20saya%20ingin%20mengetahui%20lebih%20lanjut%20tentang%20layanan%20Anda."
                  ...
                  <Link to="/" className="flex items-center mb-4 px-10">
                    <svg
                      width="30"
                      height="30"
                      viewBox="0 0 30 30"
